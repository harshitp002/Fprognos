...
const END_HOUR = import.meta.env.VITE_END_HOUR;
...
const DateTime = (props: any) => {
  ...
  return (
    <>
      <div className='flex flex-row flex-wrap text-center justify-center gap-4 p-2 m-1 rounded-md border-[1px]'>

        {/* start time of trade */}
        <div className=" flex flex-col min-w-[210px]">
          {props.rangeBreakOut && <label className="text-[14px] text-left">Range Start Time</label>}
          {!props.rangeBreakOut && <label className="text-[14px] text-left">Start Time</label>}
        ...
        {props.rangeBreakOut && <div className=" flex flex-col min-w-[210px]">
          <label className="text-[14px] text-left">Range End Time</label>
          <div className='flex flex-row text-center justify-start'>
        ...
        {/* exit time of trade */}
        <div className=" flex flex-col min-w-[210px]">
          <label className="text-[14px] text-left">End Time</label>
          <div className='flex flex-row text-center justify-start'>
